...
(1, 'AUTO-001-2025', 'AUTO', 'Seguros Sura', '2025-01-15', DATE('now', '+3 days'), 'ACTIVA', 0, 1, 1);
INSERT OR IGNORE INTO policies (id, policy_number, type, insurer, start_date, expiration_date, status, renewal_count, client_id, advisor_id) VALUES
(2, 'HOGAR-002-2025', 'HOGAR', 'Mapfre', '2025-03-01', DATE('now', '+20 days'), 'ACTIVA', 0, 2, 1);
INSERT OR IGNORE INTO policies (id, policy_number, type, insurer, start_date, expiration_date, status, renewal_count, client_id, advisor_id) VALUES
(3, 'AUTO-003-2025', 'AUTO', 'Allianz', '2025-06-01', DATE('now', '+120 days'), 'ACTIVA', 0, 3, 1);
INSERT OR IGNORE INTO policies (id, policy_number, type, insurer, start_date, expiration_date, status, renewal_count, client_id, advisor_id) VALUES
(4, 'VIDA-004-2025', 'VIDA', 'Sura', '2025-02-01', DATE('now', '+180 days'), 'ACTIVA', 0, 4, 1);
INSERT OR IGNORE INTO policies (id, policy_number, type, insurer, start_date, expiration_date, status, renewal_count, client_id, advisor_id) VALUES
(5, 'AUTO-005-2024', 'AUTO', 'Bolívar', '2024-06-01', DATE('now', '-2 days'), 'ACTIVA', 0, 5, 1);
INSERT OR IGNORE INTO policies (id, policy_number, type, insurer, start_date, expiration_date, status, renewal_count, client_id, advisor_id) VALUES
(6, 'AUTO-006-2024', 'AUTO', 'Sura', '2024-07-01', DATE('now', '-15 days'), 'ACTIVA', 0, 6, 1);
INSERT OR IGNORE INTO policies (id, policy_number, type, insurer, start_date, expiration_date, status, renewal_count, client_id, advisor_id) VALUES
(7, 'AUTO-007-2024', 'AUTO', 'Mapfre', '2024-05-01', DATE('now', '-45 days'), 'ACTIVA', 0, 7, 1);
INSERT OR IGNORE INTO policies (id, policy_number, type, insurer, start_date, expiration_date, status, renewal_count, client_id, advisor_id) VALUES
