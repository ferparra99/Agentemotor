...
public interface PolicyApi {
    ...
    @GetMapping("/list")
    ResponseEntity<List<PolicySummaryDTO>> listByAdvisorAndFilter(
    ...
    ResponseEntity<PolicyDetailDTO> getById(
    ...
    @PostMapping("/create")
    ResponseEntity<PolicySummaryDTO> create(
    ...
    @Operation(
        ...
        description = """
            Actualiza los datos de una póliza existente. El ID se toma del path.
    ...
    ResponseEntity<PolicySummaryDTO> update(
    ...
    @PutMapping("/renew/{id}")
    ResponseEntity<PolicySummaryDTO> renew(
    ...
    ResponseEntity<ContactAttemptDTO> registerAttempt(
            @Parameter(description = "ID de la póliza", required = true, example = "1")
            @PathVariable Long id,
